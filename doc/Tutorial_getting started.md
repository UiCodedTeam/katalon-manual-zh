...
| ![avatar](../imgs/ln/img-002-13.png) | 停止当前的测试执行会话。                                     |
...
![avatar](../imgs/ln/img-002-48.png)

## 作业进度视图

Job Progress 视图允许您查看执行测试用例和测试套件的进度。

![avatar](../imgs/ln/img-002-49.png)
