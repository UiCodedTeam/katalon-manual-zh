...
![avatar](../imgs/ln/img-007-06.png)

### 第 3 步：在对象存储库中创建一个新的 RESTful 端点

**对象存储库**->**新建**-> **Web 服务请求**

![avatar](../imgs/ln/img-007-07.png)
...
![avatar](../imgs/ln/img-007-08.png)

单击**OK**，然后我们准备为第一个 RESTful 测试输入更多详细信息。

![avatar](../imgs/ln/img-007-09.png)
...
![avatar](../imgs/ln/img-007-10.png)

**(4) 验证**

验证是您定义断言以确保响应将包含预期信息的地方。

![avatar](../imgs/ln/img-007-11.png)
